...
import com.makadown.springboot.app.models.entity.ItemFactura;

/* Más ejemplos en 
 * https://developers.itextpdf.com/examples/tables-itext5 */
...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		cell = new PdfPCell( new Phrase(new Phrase(messageSource.getMessage("text.factura.ver.datos.factura",null, locale))));
		...
		tabla3.setTotalWidth(new float[] { 3.5f, 1f, 1f, 1f });
